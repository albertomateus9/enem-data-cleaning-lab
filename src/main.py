...
PROJECT = {
  "code": "P01",
  "slug": "enem-data-cleaning-lab",
  "title": "ENEM Data Cleaning Lab",
  ...
  "kind": "cleaning",
  "dataset": "ENEM microdata public dataset",
  "source": "https://dados.gov.br/",
  "description": "Educational lab for cleaning ENEM-like tabular data with pandas and safe sample files.",
  "concepts": [
    "read_csv",
    "drop columns",
    "fill missing values",
